...
create table t_git_repository
(
    git_repository_id bigint auto_increment comment '主键'
        primary key,
...
(
    ...
    log             text null comment '监控信息',
    begin_date_time datetime    not null comment '任务开始时间',
    end_date_time   datetime null comment '任务结束时间',
