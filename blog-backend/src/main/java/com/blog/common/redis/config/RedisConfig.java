...
public class RedisConfig {
    ...
    public RedissonAutoConfigurationCustomizer redissonCustomizer() {
        return config -> {
            ...
            config.setThreads(redissonProperty.getThreads()).setNettyThreads(redissonProperty.getNettyThreads())
            ...
            if (ObjectUtil.isNotNull(clusterServersConfig)) {
                config.useClusterServers()
                    // 设置redis key前缀
                    .setNameMapper(new KeyPrefixHandler(redissonProperty.getKeyPrefix()))
                    .setTimeout(clusterServersConfig.getTimeout()).setClientName(clusterServersConfig.getClientName())
