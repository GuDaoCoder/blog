...
public class BlogSyncServiceImpl implements BlogSyncService {
    ...
    public void sync() {
        ...
        List<File> files = FileUtil.loopFiles(gitProjectProperties.getLocalRepositoryPath(),
        ...
        for (File file : files) {
            PostParserContext postParserContext = MarkdownParser.parse(file,
                    gitProjectProperties.getLocalRepositoryPath());
    ...
    private void syncNoteProject() {
        GitHelper gitHelper = new GitHelper(gitProjectProperties.getGitRepositoryUrl(),
                gitProjectProperties.getLocalRepositoryPath(), gitProjectProperties.getUsername(),
                gitProjectProperties.getPassword());
        try {
